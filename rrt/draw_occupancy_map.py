...
if __name__ == "__main__":    
    ...
    parser.add_argument('--mesh_name', type=str, default='/home/reza/Datasets/GibsonEnv/gibson/assets/dataset/Allensville/mesh_z_up.obj')
    parser.add_argument('--trajFilePath', type=str, default=None)
