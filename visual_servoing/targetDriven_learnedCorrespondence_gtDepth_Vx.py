...
approach_folder = '{}/learnedCorrespondence_gtDepth_Vx'.format(base_folder)
...
sampled_image_folder = '/home/reza/Datasets/GibsonEnv/my_code/visual_servoing/sample_image_pairs/{}/point_{}'.format(scene_name, point_idx)
...
goal_img = cv2.imread('{}/{}.png'.format('/home/reza/Datasets/GibsonEnv/my_code/visual_servoing/target_objects', target_obj_name), 1)[:,:,::-1]
