...
perception_rep =  'gtSparse' #'learnedSparse' # # 'gtDense', 'sift', 
depth_method = 'void' #'gt' # 'estimated', 
...
def main(scene_idx=0):
	...
	'''
	approach_folder = '{}/gtCorrespondence_interMatrix_noDepth_OmegaY'.format(test_folder)
	...
	#for point_idx in range(0, 1):
		...
		#for right_img_idx in range(1, 10):
			...
			while count_steps < num_steps:
				...
				omegay, flag_stop = compute_angular_velocity_through_correspondences(kp1, kp2)
				previous_pose = current_pose
				current_pose = update_current_pose(current_pose, 0.0, 0.1, omegay)
