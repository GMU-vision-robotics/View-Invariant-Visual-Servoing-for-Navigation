...
perception_rep = 'sift' #'learnedSparse' #'gtSparse' # 'gtDense', , 
depth_method = 'void' # 'estimated', 'void'
...
def main(scene_idx=0):
	...
	'''
	approach_folder = '{}/SIFT_interMatrix_noDepth_OmegaY'.format(test_folder)
	...
	#for point_idx in range(0, 1):
		...
		#for right_img_idx in range(1, 10):
			...
			while count_steps < num_steps:
				...
				omegay, flag_stop = compute_angular_velocity_through_correspondences(kp1, kp2, 100)
