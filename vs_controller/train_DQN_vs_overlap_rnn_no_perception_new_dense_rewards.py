...
class DQN_vs_overlap_rnn_no_perception_new:
    ...
    def update(self, batch_size, time_step=5):
        ...
        Qvals, _ = self.actor.forward(states, hidden_batch, batch_size=batch_size) ## batch_size x action_space
        ...
        next_Q, _ = self.critic.forward(next_states, hidden_batch, batch_size=batch_size)##batch_size x action_space
